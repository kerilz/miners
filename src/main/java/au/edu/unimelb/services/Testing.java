...
//    private static String logpath = ".\\PRT";
    ...
    private static Opd MODE = Opd.GRD;
            ...
            try {
                while(o<MAXO) {
                    if(YSM) {
                        ...
                        smp[o] = calculator.precision(Abs.MARK, MODE, log, smM, o + 1);
                    ...
                    if(YSHM) {
                        time = System.currentTimeMillis();
                        shmp[o] = calculator.precision(Abs.MARK, MODE, log, shmM, o + 1);
                        time = (System.currentTimeMillis() - time) / 1000.00;
                        System.out.println("TIME - " + time);
                        shmp_avgtime[o] += time;
                    ...
                    if(YIM) {
                        time = System.currentTimeMillis();
                        imp[o] = calculator.precision(Abs.MARK, MODE, log, imM, o + 1);
                        time = (System.currentTimeMillis() - time) / 1000.00;
                        System.out.println("TIME - " + time);
                        imp_avgtime[o] += time;
